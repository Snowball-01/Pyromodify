...
class Message(Object, Update):
    ...
    def __init__(
        ...
        *,
        ...
        chat_has_protected_content_disable_requested: Optional[
            "types.ChatHasProtectedContentDisableRequested"] = None,
        ...
        if isinstance(message, raw.types.MessageEmpty):
            ...
            if peer_id:
                if isinstance(message.peer_id, raw.types.PeerUser):
                    sender_chat = types.Chat._parse_user_chat(
        ...
        if isinstance(message, raw.types.MessageService):
            ...
            if isinstance(action, raw.types.MessageActionChatAddUser):
                ...
                from_user = types.User._parse(
                    client, users.get(action.inviter_id, None))
                ...
                chat_owner_left = types.ChatOwnerLeft._parse(
                    client, action, users)
                ...
                chat_has_protected_content_disable_requested = types.ChatHasProtectedContentDisableRequested._parse(
                    client, action)
                ...
                new_chat_members = [types.User._parse(
                    client, users[user]) for user in action.users]
                new_chat_title = action.title
                ...
                new_chat_photo = types.Animation._parse_chat_animation(
                    client, action.photo) or types.Photo._parse(client, action.photo)
                ...
                video_chat_participants_invited = types.VideoChatParticipantsInvited._parse(
                    client, action, users)
                ...
                if connected_website:
                    ...
                    write_access_allowed = types.WriteAccessAllowed._parse(
                        action)
                ...
                checklist_tasks_done = types.ChecklistTasksDone._parse(
                    client, message)
            ...
            parsed_message = Message(
                ...
                reactions=types.MessageReactions._parse(
                    client, message.reactions) if message.reactions else None,
        ...
        if isinstance(message, raw.types.Message):
            ...
            if media:
                if isinstance(media, raw.types.MessageMediaPhoto):
                        ...
                        if raw.types.DocumentAttributeAnimated in attributes:
                            ...
                            if video_attributes.round_message:
                                ...
                                video = types.Video._parse(
                                    client, media, video_attributes, file_name, media.ttl_seconds)
                    ...
                    checklist = types.Checklist._parse(
    ...
    async def reply_text(
        ...
        return await self._client.send_message(
            ...
            paid_message_star_count=(
                self and self.chat and self.chat.paid_message_star_count) or None,
        ...
        if self.service:
            ...
            if self.photo:
                ...
                return await self._client.send_video(
                    ...
                    caption_entities=caption_entities,
                    show_caption_above_media=show_caption_above_media or self.show_caption_above_media,
                    cover=video_cover if video_cover else self.video.cover.sizes[
                        -1].file_id if self.video.cover else None,
